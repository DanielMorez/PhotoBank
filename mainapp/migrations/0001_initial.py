# Generated by Django 3.1.4 on 2021-01-05 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.album', verbose_name='Альбом')),
                ('type_of_photo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.phototype', verbose_name='Тип фотографии')),
            ],
            options={
                'abstract': False,
            },
